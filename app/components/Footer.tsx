...
export const Footer = async () => {
  ...
  return (
    ...
    >
      ...
      <div className="bigtab:flex-nowrap] relative z-[2] flex flex-wrap gap-x-[30px] gap-y-[30px] px-[3vw] pt-[40px] sm:justify-between sm:px-[80px] lg:pt-[80px] small:gap-y-[50px]">
        ...
        <div className="order-3 w-full text-sm font-[200] sm:w-[calc(30%-20px)] xl:w-[18%] bigtab:w-[15%]">
          ...
          <Link href="/about" className={`mt-[7px] block w-fit ${s.hoverable}`}>
            About us
          </Link>
          <Link
            href="/services"
          ...
          <Link href="/sell" className={`mt-[6px] block w-fit ${s.hoverable}`}>
            Sell your property
          </Link>
          <Link
            href="/careers"
          ...
          <Link href="/news" className={`mt-[6px] block w-fit ${s.hoverable}`}>
            News & Events
          </Link>
          <Link
            href="/contact"
