...
export const ScrollingSections = () => {
  ...
  useGSAP(() => {
    ...
    return () => {
      ...
      const bodyDivCleanup = document.querySelector(
        'body > div',
      ) as HTMLElement | null;
      if (bodyDivCleanup) {
  ...
  return (
    <>
      <div className="verticalSection section  w-full flex-col 3xl:max-w-[1200px]">
        <HomeHero />
        <FeaturedProperties />
        <AboutLiv />
        <div className="gotham home-sec_title mt-[45px] text-[40px] gothamBold leading-[39px] sm:text-[45px] sm:leading-[42.3px]">
