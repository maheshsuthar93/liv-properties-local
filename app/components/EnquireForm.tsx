...
import ContactUsInfo from '../contact/contactUsSuccess';
import ContactUsSuccess from '../contact/contactUsSuccess';
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="mt-[43px] text-white">
        ...
        {visible && (
          <ContactUsSuccess setVisible={setVisible} visible={visible} />
        )}
      </form>
    </>
  );
