    ...
    <div className="verticalPanelInner featured-properties mt-[10px] flex flex-col px-[3vw]  sm:px-0 3xl:max-w-[1200px]">
      <div className="max-[1024px]:justify-between mb-[30px] flex flex-wrap justify-normal gap-8 small:mb-0">
        <div className="home-sec_title gotham text-[35px] font-[700] leading-[39px] sm:text-[35px] sm:leading-[42.3px]">
          <div className="inline-block  capitalize ">Featured Properties</div>
        </div>
        {isLargeScreen ? (
          <div className="helveticaNeue mt-[39px] flex-wrap text-[16px] font-[500] font-[500] sm:mb-[14px] sm:mt-0">
            <div className="flex">
              <div
          ...
          <>
            <div className="helveticaNeue flex w-full items-stretch text-center text-[18px] font-[500] ">
              <div
      ...
      {featuredPropertiesError && (
        <div className="mt-[20px] w-full md:mt-[43px]">
          Error loading featured properties: {featuredPropertiesError.message}
        </div>
      )}
